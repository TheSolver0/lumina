<div class="bottombar">
			...
			<div class="popup-meta">
				...
				<div class="postbox">
					...
					<div class="friend-info">
						<figure>
							<img alt="" src="images/resources/admin.jpg" class="pp">
						</figure>
	...
	<script src="{{ asset("assets/js/jquery-stories.js") }}"></script>
	...
	<script src="{{ asset("assets/js/locationpicker.jquery.js") }}"></script><!-- for loaction picker map -->
	<script src="{{ asset("assets/js/map-init.js") }}"></script><!-- map initilasition -->
