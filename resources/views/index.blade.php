								...
								<aside class="sidebar static left">
									...
									<div class="widget">
										...
										<ul class="naves">
											...
											<li>
												<i class="ti-user"></i>
												<a href="timeline-friends.html" title="">Problemes Releves de notes</a>
											</li>
											<li>
												<i class="ti-image"></i>
										...
										<ul class="activitiez">
											<li>
												<div class="activity-meta">
													<i>Il y'a 10 ans</i>
													<span><a href="#" title="">Vous avez commenté sur une vidéo postée</a></span>
								...
								<div class="central-meta postbox">
									...
									<div class="new-postbox">
										...
										<div class="newpst-input">
											<form method="post">
												<textarea rows="2" placeholder="Rediger votre post"></textarea>
											</form>
										</div>
										<div class="attachments">
											<ul>
												...
												<li class="preview-btn">
													<button class="post-btn-preview" type="submit" data-ripple="">Previsualise</button>
												</li>
											</ul>
									...
									<div class="story-postbox">
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="story-box">
													<figure>
														<img src="assets/images/resources/story-1.jpg" alt="">
											...
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="story-box">
													<figure>
														<img src="assets/images/resources/story-2.jpg" alt="">
											...
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="story-box">
													<figure>
														<img src="assets/images/resources/story-3.jpg" alt="">
											...
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="story-box">
													<figure>
														<img src="assets/images/resources/story-4.jpg" alt="">
														<span>Jhon Deo</span>
													</figure>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="stories-users">
															<h5>Stories</h5>
															<div class="my-status">
																<figure><img src="assets/images/resources/friend-avatar10.jpg" alt=""></figure>
															...
															<ul class="frnds-stories">
																<li>
																	<figure><img src="assets/images/resources/friend-avatar11.jpg" alt=""></figure>
																	<div class="story-user">
																...
																<li>
																	<figure><img src="assets/images/resources/friend-avatar15.jpg" alt=""></figure>
																	<div class="story-user">
																...
																<li>
																	<figure><img src="assets/images/resources/friend-avatar12.jpg" alt=""></figure>
																	<div class="story-user">
																...
																<li>
																	<figure><img src="assets/images/resources/friend-avatar13.jpg" alt=""></figure>
																	<div class="story-user">
																...
																<li>
																	<figure><img src="assets/images/resources/friend-avatar14.jpg" alt=""></figure>
																	<div class="story-user">
																		<span>Zing Jang</span>
																		<ins>2 days ago</ins>
																	</div>
																...
																<li>
																	<figure><img src="assets/images/resources/friend-avatar16.jpg" alt=""></figure>
																	<div class="story-user">
								...
								<div class="loadMore">
													...
													<div class="more">
														<div class="more-post-optns"><i class="ti-more-alt"></i>
															<ul>
																...
																<li><i class="fa fa-clock-o"></i>Planifier un post</li>
																<li><i class="fa fa-wpexplorer"></i>Sélectionner comme post mis en avant</li>
																<li><i class="fa fa-bell-slash-o"></i>Désactiver les notifications</li> -->
															</ul>
														</div>
													</div>
															...
															<div class="row">
																<div class="col-lg-6 col-md-6 col-sm-6">
																	<figure>
																		...
																		<img src="assets/images/resources/album1.jpg" alt="">
																		</a>
																	</figure>
																	<figure>
																		<a href="#" title="" data-toggle="modal" data-target="#img-comt">
																		<img src="assets/images/resources/album2.jpg" alt="">
																		</a>
																	</figure>
																</div>
																<div class="col-lg-6 col-md-6 col-sm-6">
																	<figure>
																		<a href="#" title="" data-toggle="modal" data-target="#img-comt">
																		<img src="assets/images/resources/album6.jpg" alt="">
																		</a>
																	</figure>
																	<figure>
																		<a href="#" title="" data-toggle="modal" data-target="#img-comt">
																		<img src="assets/images/resources/album5.jpg" alt="">
																		</a>
																	</figure>
																	<figure>
																		<a href="#" title="" data-toggle="modal" data-target="#img-comt">
																		<img src="assets/images/resources/album4.jpg" alt="">
																		</a>
									...
									{{-- <div class="central-meta item">
										<div class="user-post">
											<div class="friend-info">
												...
												<div class="post-meta">
													<figure>
														<img src="assets/images/sponsors.gif" alt="">
														<ul class="like-dislike">
															<li><a class="bg-purple" href="#" title="Save to Pin Post"><i class="fa fa-thumb-tack"></i></a></li>
															<li><a class="bg-blue" href="#" title="Like Post"><i class="ti-thumb-up"></i></a></li>
															<li><a class="bg-red" href="#" title="dislike Post"><i class="ti-thumb-down"></i></a></li>
									...
									{{-- <div class="central-meta item">
										<div class="user-post">
											<div class="friend-info">
												<figure>
													<img alt="" src="assets/images/resources/friend-avatar10.jpg">
												</figure>
												<div class="friend-name">
													<div class="more">
														<div class="more-post-optns"><i class="ti-more-alt"></i>
												...
												<div class="post-meta">
													<div class="linked-image align-left">
														<a title="" href="#"><img alt="" src="assets/images/resources/page1.jpg"></a>
													</div>
													<div class="detail">
